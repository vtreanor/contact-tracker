...
const PersonEdit = () => {
	...
	return (
		<div style={container}>
			<div style={section_0}>
				<div style={div_0}>
					<div style={div_0_0}>Create a New Contact</div>
				</div>
				...
				<div style={section_1}>
					<div style={row}>
						<div style={item}>
							...
							<input style={input} name='firstName' />
						</div>
						<div style={item}>
							<div style={label}>Last name</div>
							<input style={input} name='lastName' />
						</div>
					</div>
					<div style={row}>
						<div style={item}>
							<div style={label}>Age</div>
							<input style={input}  name='age' />
						</div>
						<div style={item}>
							<div style={label}>Progress </div>
							<input style={input}  name='progress' />
						</div>
					</div>
					<div style={row}>
						<div style={item}>
							<div style={label}>Status</div>
							<input style={input}  name='status' />
						</div>
						<div style={item}>
							<div style={label}>Visits</div>
							<input style={input}  name='visits' />
						</div>
					</div>
					<div style={iconBar}>
